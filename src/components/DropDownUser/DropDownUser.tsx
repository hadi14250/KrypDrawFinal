    ...
    <div className="relative">
      ...
      >
        ...
        <Image
          ...
          src={
            isProfile
              ? "/static/images/user_profile_red.svg"
              : "/static/images/user_profile.png"
          }
          alt="User"
        />
      ...
      <div
        ...
        style={{
          background: "rgba(21, 17, 44, 0.8)",
        }}
        className={`absolute right-0 mt-4 z-[9999] flex w-62.5 flex-col rounded-sm border border-stroke shadow-default dark:border-strokedark dark:bg-boxdark ${
